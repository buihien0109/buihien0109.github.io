    ...
    value: function render() {
      ...
      var renderBrand = brands.map(function (brand, index) {
        return __jsx(next_link__WEBPACK_IMPORTED_MODULE_8___default.a, {
          href: "/shop?page=".concat(i + 1, "&sort=").concat(sort, "&order=").concat(order, "page=").concat(i + 1, "&sort=").concat(sort, "&order=").concat(order, "brand=").concat(brand),
          key: index,
          __source: {
...
//# sourceMappingURL=shop.js.13f2adb120e6413790e8.hot-update.js.map
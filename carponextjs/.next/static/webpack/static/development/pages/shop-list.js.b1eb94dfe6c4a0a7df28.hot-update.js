  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          data = _context.sent;
          console.log("Show data fetched. Count: ".concat(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(data))); // return {
          //   products: data.map(entry => entry.show)
          // };
...
//# sourceMappingURL=shop-list.js.b1eb94dfe6c4a0a7df28.hot-update.js.map
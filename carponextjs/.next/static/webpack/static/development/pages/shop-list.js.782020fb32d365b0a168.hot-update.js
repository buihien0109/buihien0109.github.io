...
var Sort = function Sort(props) {
  ...
  var renderType = function renderType(type) {
    var list = listProducts.map(function (product) {
      return product.color;
    });
    list = list.filter(function (color, i) {
      return list.indexOf(color) === i;
    }); //Render color
...
//# sourceMappingURL=shop-list.js.782020fb32d365b0a168.hot-update.js.map
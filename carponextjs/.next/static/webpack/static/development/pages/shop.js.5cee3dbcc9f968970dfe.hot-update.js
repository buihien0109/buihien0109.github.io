...
var Product = function Product(_ref) {
  var products = _ref.products,
      onAddToCard = _ref.onAddToCard;

  var handleAddToCard = function handleAddToCard(id, e) {
    onAddToCard(id);
  };
  ...
  var productList = products.map(function (item, index) {
    return __jsx("li", {
      ...
      onClick: function onClick() {
        return handleAddToCard(item.id);
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 54
...
//# sourceMappingURL=shop.js.5cee3dbcc9f968970dfe.hot-update.js.map
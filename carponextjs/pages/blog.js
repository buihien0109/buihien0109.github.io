...
const Blog = () => {
  const listBlog = [
    {
      id: 1,
      title:
        "Sợi Bamboo là gì? Tại sao Áo Sơ Mi sợi Bamboo lại được ưa chuộng như vậy",
      description:
        "Sợi bamboo hay còn gọi là sợi tre,có thành phần chủ yếu từ cây tre, tre được biết đến là loại cây dễ trồng, sinh trưởng nhanh, đặc biệt không cần phun thuốc hoá học khi trồng nên khi được sử dụng làm sợi thì loại sợi này được coi là sợi tương đối an toàn!",
      image: "/images/11.jpg"
    },
    {
      id: 2,
  ...
  const renderBlog = listBlog.map(blog => {
    return (
            ...
            <div className="row">
              <div className="col-xs-12 col-sm-9" id="center_column">
                <div className="center_column">
                  ...
                  <ul className="blog-posts">{renderBlog}</ul>
                        ...
                        <ul className="blog-list-sidebar">
                          ...
                          <li>
                            ...
                            <div className="post-info">
                              <h5 className="entry_title">
                                <a href="#">
                                  TOP 99 Mẫu Áo Khoác Jeans nam mới nhất 2019
                                  cho các chàng Trai Thời Thượng
                                </a>
                              </h5>
                              <div className="post-meta">
                                {" "}
                        ...
                        <ul className="recent-comment-list">
                          <li>
                            <h5>
                              <a href="#">
                                <b>
                                  Áo Khoác Parka thường được gọi với cái tên
                                  “bình dân”
                                </b>
                              </a>
                            </h5>
                          ...
                          <li>
                            <h5>
                              <a href="#">
                                <b>
                                  Vải jeans được mệnh danh chất liệu sở hữu sự
                                  trẻ trung
                                </b>
                              </a>
                            </h5>
                            <div className="comment">
                              ...
                              chuộng và trở thành item phải có đối với các tín
                              đồ thời trang...."{" "}
                            </div>
                            <div className="author">
                              Đăng bởi <a href="#">Admin</a>
                          ...
                          <li>
                            <h5>
                              <a href="#">
                                <b>
                                  Đối với những chàng trai theo phong cách bụi
                                  bặm
                                </b>
                              </a>
                            </h5>

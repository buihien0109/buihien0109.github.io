                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-7">
                          <h3 className="entry-title">
                            <a href="./blog-detail.html">
                              Sợi Bamboo là gì? Tại sao Áo Sơ Mi sợi Bamboo lại
                              được ưa chuộng như vậy
                            </a>
                          </h3>
                      ...
                      <div className="row">
                        <div className="col-sm-5">
                          <div className="entry-thumb">
                            ...
                            <a href="./blog-detail.html">
                              <figure>
                                <img src="./images/13.jpg" alt="Blog" />
                              </figure>
                            </a>{" "}
                          </div>
                        </div>
                        <div className="col-sm-7">
                          <h3 className="entry-title">
                            <a href="./blog-detail.html">
                              Đừng tiếc Chi mạnh tay cho 48 mẫu Áo Khoác Parka
                              Cực Ấm, Ưa Chuộng nhất mùa Lạnh này
                            </a>
                          </h3>
                          <div className="entry-meta-data">
                            {" "}
                          ...
                          <div className="entry-excerpt">
                            Để chống chọi hiệu quả với cái rét ẩm của miền Bắc,
                            bạn nên diện những chiếc áo dày dặn bên trong như
                            len vặn thừng để giữ ấm tuyệt đối cho cơ thể. Cũng
                            nên chọn áo trong có gam màu tương phản với áo parka
                            để trang phục thêm nổi bật hơn trong các mẫu dưới
                            đây của H2T nhé.
                          </div>
                          <a href="./blog-detail.html" className="read-more">
                            Xem thêm&nbsp;{" "}
                      ...
                      <div className="row">
                        <div className="col-sm-5">
                          <div className="entry-thumb">
                            ...
                            <a href="./blog-detail.html">
                              <figure>
                                <img src="./images/14.jpg" alt="Blog" />
                              </figure>
                            </a>{" "}
                          </div>
                        </div>
                        <div className="col-sm-7">
                          ...
                          <div className="entry-excerpt">
                            ...
                            trung vĩnh cửu và trở thành nguồn cảm hứng cho nhiều
                            nhà tạo mốt lớn trên thế giới. .
                          </div>
                          <a href="./blog-detail.html" className="read-more">
                            Xem thêm&nbsp;{" "}
                            <i className="fa fa-angle-double-right" />
                      ...
                      <div className="row">
                        <div className="col-sm-5">
                          <div className="entry-thumb">
                            ...
                            <a href="./blog-detail.html">
                              <figure>
                                <img src="./images/15.png" alt="Blog" />
                              </figure>
                            </a>{" "}
                          </div>
                        </div>
                        <div className="col-sm-7">
                          <h3 className="entry-title">
                            <a href="./blog-detail.html">
                              Hướng dẫn chọn size áo và size giày nam chuẩn khi
                              mua hàng online
                            </a>
                          </h3>
                          <div className="entry-meta-data">
                          ...
                          <div className="entry-excerpt">
                            Phái mạnh thường ít quan tâm tới số đo hay size áo
                            chuẩn mà thường thử đồ nào vừa thì chọn size đó. Tuy
                            nhiên, để sở hữu những chiếc áo chuẩn form thì những
                            thông số dưới đây sẽ giúp bạn chọn được những chiếc
                            áo vừa in và tiện lợi hơn khi không bị lung túng khi
                            mua hàng online.
                          </div>
                          <a href="./blog-detail.html" className="read-more">
                            Xem thêm&nbsp;{" "}
                      ...
                      <div className="row">
                        <div className="col-sm-5">
                          <div className="entry-thumb">
                            ...
                            <a href="./blog-detail.html">
                              <figure>
                                <img src="./images/16.jpg" alt="Blog" />
                              </figure>
                            </a>{" "}
                          </div>
                        </div>
                        <div className="col-sm-7">
                          <h3 className="entry-title">
                            <a href="./blog-detail.html">
                              Cách sử dụng và bảo quản giày da như mới | H2T
                            </a>
                          </h3>
                          <div className="entry-meta-data">
                            {" "}
                          ...
                          <div className="entry-excerpt">
                            Giày da đã và đang là một người bạn thân thiết với
                            chúng ta từ các hoạt động công tác, học tập cho đến
                            những buổi đi chơi, dạo phố. Tuy nhiên chất liệu da
                            và ở vị trí của một đôi giày thì việc gìn giữ độ bền
                            cho đôi giày da của bạn dường như chưa được quan tâm
                            nhiều.
                          </div>
                          <a href="./blog-detail.html" className="read-more">
                            Xem thêm&nbsp;{" "}
                      ...
                      <div className="row">
                        <div className="col-sm-5">
                          <div className="entry-thumb">
                            ...
                            <a href="./blog-detail.html">
                              <figure>
                                <img src="./images/17.jpg" alt="Blog" />
                              </figure>
                            </a>{" "}
                          </div>
                        </div>
                        <div className="col-sm-7">
                          <h3 className="entry-title">
                            <a href="./blog-detail.html">
                              Mách nhỏ giữ áo thun bền đẹp như mới
                            </a>
                          </h3>
                          <div className="entry-meta-data">
                            {" "}
                          ...
                          <div className="entry-excerpt">
                            Khi mới mua áo thun về, nếu áo thun có đính hạt hoặc
                            có hình in bạn nên lộn trái áo lại dùng bàn ủi, ủi
                            lại phía sau để tăng độ bền của hình in và hạt trang
                            trí. Để tăng độ bền màu áo, bạn đừng vội giặt áo với
                            xà phòng mà nên ngâm áo trong nước lạnh pha giấm
                            hoặc muối khoảng tiếng rồi xả sạch với nước lạnh,
                            cách làm này khiến màu của áo hạn chế bị phai trong
                            quá trình sử dụng
                          </div>
                          <a href="./blog-detail.html" className="read-more">
                            Xem thêm&nbsp;{" "}
                    ...
                    <article className="entry">
                      <div className="row">
                        ...
                        <div className="col-sm-7">
                          <h3 className="entry-title">
                            <a href="./blog-detail.html">
                              Mẹo xử lí vết bẩn cứng đầu dính trên áo khoác gió
                            </a>
                          </h3>
                          <div className="entry-meta-data">
                            {" "}
                          ...
                          <div className="entry-excerpt">
                            Nếu vô tình bị đổ cà phê hay nước trà nên áo khoác
                            mà bạn không có thời gian để giặt nó ngay lập tức
                            thì các vết bẩn này sẽ khó được tẩy sạch. Ngay khi
                            bị bẩn bạn hoàn toàn có thể giặt sạch nó trong nước
                            ấm. Tuy nhiên trong trường hợp bạn đang ở công sở
                            tất nhiên phải đợi đến khi về nhà bạn mới có thể
                            giặt nó, lúc này vết bẩn đã khô lại, bạn có thể làm
                            theo cách sau.
                          </div>
                          <a href="./blog-detail.html" className="read-more">
                            Xem thêm&nbsp;{" "}

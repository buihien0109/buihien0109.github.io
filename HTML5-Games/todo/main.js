...
// TODO : Danh sách công việc sau này được lưu vào local storeage trong máy người dùng
let todos = [
    {
        id : create_UUID(),
    ...
    {
        id : create_UUID(),
        title : 'Mua đồ ăn chuẩn bị cho bữa tối',
        status : false
    },
    {
        id : create_UUID(),
        title : 'Làm chương trình Girl learn to code dự án "Xôi thịt"',
        status : false
    },
]
...
function renderUI(arr) {
    ...
    if(newTodos.length == 0) {
        todo_list.innerHTML = 'Không có công việc'
        return
    }

...
class Board {
    ...
    drawWin() {
        if (this.win.isWin) {
            let startX = this.win.start.startJ * this.cellWidth;
            let startY = this.win.start.startI * this.cellWidth;
            let endX = this.win.end.endJ * this.cellWidth;
            let endY = this.win.end.endI * this.cellWidth;

            c.strokeStyle = "#000";
            c.beginPath();
            c.save();
            c.translate(this.cellWidth / 2, this.cellWidth / 2);

...
window.onload = function () {
    ...
    btn_submit.addEventListener("click", function () {
        ...
        if (isValid) {
            ...
            result_num.innerHTML(bmi.toFixed(2));
    ...
    function renderUI(num) {
        ...
        result_title.textContent(contentUI.title);
        result_content.textContent(contentUI.content);
    }
